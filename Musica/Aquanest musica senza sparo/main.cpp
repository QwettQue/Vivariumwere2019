...
#define N 10                 // costante indica numero navi
...
int main()
{
    ...
    {
        interfaccia();
        PlaySound("arms.wav", NULL, SND_FILENAME|SND_LOOP|SND_ASYNC);
        printf("Digita:\n");
        ...
        if(x==1)
        {
            PlaySound("kass.wav", NULL, SND_FILENAME|SND_LOOP|SND_ASYNC);
            regole();//asci art
            system("PAUSE");
            system("cls");
        }
        ...
        else if(x==2)
        {
            ...
            cin>>nomeg1;
            system("cls");
            PlaySound("jotaro.wav", NULL, SND_FILENAME|SND_LOOP|SND_ASYNC);
            ...
            while(gioca == 0)//Esce dal while solo quando l utente inserisce -1 e quando un giocatore vince
            {
                ...
                for(i=0; i<C; i++)//Ciclo da aggiornare
                {
                    ...
                    for (j=0; j<C; j++)
                    {
                        ...
                        {
                            printf("[X]");
                            PlaySound("gun.wav", NULL, SND_FILENAME|SND_LOOP|SND_ASYNC);
                        }
